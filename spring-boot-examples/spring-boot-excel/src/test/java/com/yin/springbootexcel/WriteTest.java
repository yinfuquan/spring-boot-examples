...
import com.yin.springbootexcel.listen.AfterWriteHandlerImpl;
...
import static com.yin.springbootexcel.util.DataUtil.*;
...
public class WriteTest {
    ...
    public void writeV2007() throws IOException {
        OutputStream out = new FileOutputStream("/F:/my-spring-boot-examples/spring-boot-examples/spring-boot-examples/spring-boot-excel/upload/20010.xlsx");
